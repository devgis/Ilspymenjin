...
{
	public class dfrmControllerFirstCard : frmN3000
	{
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(dfrmControllerFirstCard));
			...
			this.f_FirstCard_Enabled = new DataGridViewCheckBoxColumn();
			...
			this.f_FirstCard_Enabled.Resizable = DataGridViewTriState.True;
			this.f_FirstCard_Enabled.SortMode = DataGridViewColumnSortMode.Automatic;
			componentResourceManager.ApplyResources(this, "$this");
			base.Controls.Add(this.btnClose);
			base.Controls.Add(this.btnEdit);
			base.Controls.Add(this.dataGridView1);
			base.Name = "dfrmControllerFirstCard";
			base.FormClosing += new FormClosingEventHandler(this.dfrmControllerFirstCard_FormClosing);
			base.Load += new EventHandler(this.dfrmControllerFirstCard_Load);
			base.KeyDown += new KeyEventHandler(this.dfrmControllerFirstCard_KeyDown);
		...
		private void dfrmControllerFirstCard_Load(object sender, EventArgs e)
		{
			...
			text += ", t_b_Door.f_FirstCard_Enabled ";
		...
		private void btnEdit_Click(object sender, EventArgs e)
		{
			...
			{
				dfrmFirstCard.DoorID = int.Parse(dataGridView.Rows[index].Cells[0].Value.ToString());
				...
				{
					dataGridView.Rows[index].Cells["f_FirstCard_Enabled"].Value = int.Parse(dfrmFirstCard.retValue);
				}
			}
		}
