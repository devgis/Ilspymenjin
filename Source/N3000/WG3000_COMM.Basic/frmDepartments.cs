...
{
	public class frmDepartments : frmN3000
	{
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmDepartments));
			...
			this.txtDeptName = new ToolStripTextBox();
			...
			this.txtDeptName.ForeColor = SystemColors.WindowText;
			this.txtDeptName.Name = "txtDeptName";
			componentResourceManager.ApplyResources(this.txtDeptName, "txtDeptName");
			this.txtDeptName.TextChanged += new EventHandler(this.txtDeptName_TextChanged);
			...
			base.TextChanged += new EventHandler(this.txtDeptName_TextChanged);
		...
		private void btnAdd_Click(object sender, EventArgs e)
		{
			using (dfrmInputNewName dfrmInputNewName = new dfrmInputNewName())
			{
				...
				dfrmInputNewName.label1.Text = wgAppConfig.ReplaceFloorRomm(CommonStr.strDepartment);
		...
		private void btnDeleteDept_Click(object sender, EventArgs e)
		{
			...
			{
				icGroup icGroup = new icGroup();
				icGroup.delete(this.txtSelectedDept.Text);
