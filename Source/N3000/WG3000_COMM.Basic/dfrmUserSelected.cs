...
{
	public class dfrmUserSelected : frmN3000
	{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(dfrmUserSelected));
			...
			base.Load += new EventHandler(this.dfrmUserSelected_Load);
